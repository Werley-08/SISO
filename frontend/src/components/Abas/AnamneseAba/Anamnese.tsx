...
const Anamnese: React.FC<AnamneseProps> = ({ paciente }) => {
  ...
  return (
    <div className="pacienteProfile-tabContent">
      {!anamnese ? (
        <>
          <EmptyStateMessage
            ...
            imageSrc={msgImage}
            /** botão só aparece se NÃO for recepcionista */
            {...(!isRecepcionista && {
        ...
        <>
          ...
          <div className="anamnese-info">
            ...
            <p>
              <strong>Altura:</strong> {anamnese.altura} cm
            </p>
            <p>
              <strong>Alergias:</strong>{" "}
              {anamnese.alergias || "Não informado"}
            </p>
            <p>
              <strong>Uso de medicamentos:</strong>{" "}
              {anamnese.medicamentos ? "Sim" : "Não"}
            </p>
            <p>
              <strong>Doenças crônicas:</strong>{" "}
              {anamnese.doencasCronica || "Não informado"}
            </p>
          </div>

          {/* botão Editar só para quem pode cadastrar/editar */}
          {!isRecepcionista && (
      ...
      <Modal
        isOpen={isModalOpen && !isRecepcionista} // recepcionista não pode abrir modal
        onClose={() => {
          setIsModalOpen(false);
          setIsEditing(false);
        }}
